...
class LetterContent(BaseModel):
    ...
    opening_paragraph: str = Field(..., description="OPENING PARAGRAPH. Establish relevance + last formation + overview of motivation") #Strategic purpose: Establish relevance + value proposition")
    core_paragraph_1: str = Field(..., description="CORE PARAGRAPH 1")
    core_paragraph_2: str = Field(..., description="CORE PARAGRAPH 2")
    career_decision_paragraph: str = Field(..., description="CORE PARAGRAPH 3")
    closing_paragraph: str = Field(..., description="LAST PARAGRAPH. Strategic purpose: Reinforce enthusiasm + call to action")
